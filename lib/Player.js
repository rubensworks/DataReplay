...
function Player(reader) {
  ...
  // TODO: execute optional data-handler specific logic when presenting data to the monitor.
  //var DataHandler = require("./datahandlers/" + this._config.datatype.name);
  //this._dataHandler = new DataHandler(this._config.options);
}
